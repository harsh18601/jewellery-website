        ...
        <div className="max-w-7xl mx-auto px-4 py-24 min-h-screen">
            <div className="space-y-12">
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-primary/10 pb-12">
                    <div>
                        <h1 className="text-4xl font-bold uppercase tracking-tighter mb-4">My Wishlist</h1>
                        <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">
                            {wishlistCount} SAVED TREASURE(S)
                        </p>
                    </div>
                    <Link href="/shop" className="text-[10px] uppercase tracking-widest font-bold border-b border-secondary pb-1 hover:text-primary hover:border-primary transition-all flex items-center group">
                ...
                {wishlistItems.length > 0 ? (
                    ...
                    <div className="text-center py-32 bg-muted/5 border border-dashed border-primary/20">
